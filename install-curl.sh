...
# Usage: curl -fsSL https://raw.githubusercontent.com/bangunx/ghe/main/install-curl.sh | bash
...
case "${1:-}" in
    --help|-h)
        ...
        echo ""
        echo "Usage: curl -fsSL https://raw.githubusercontent.com/bangunx/ghe/main/install-curl.sh | bash"
        echo ""
